...
function Logo({ size = 24 }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "flex-end", gap: size * 0.2 }}>
      <span style={{ fontFamily: "var(--font-wordmark)", fontSize: size, fontWeight: 400, letterSpacing: "-0.01em", color: ACCENT, textTransform: "uppercase", lineHeight: 1 }}>Scout</span>
